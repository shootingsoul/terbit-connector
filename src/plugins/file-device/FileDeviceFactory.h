...
#include <QObject>
#include <QtPlugin>
#include "FileDevice_global.h"
#include "connector-core/IDataClassFactory.h"

namespace terbit
{

class FileDeviceFactory : public QObject, public terbit::IDataClassFactory
{
   Q_OBJECT
   Q_PLUGIN_METADATA(IID IDataClassFactory_iid FILE "FileDeviceFactory.json")
