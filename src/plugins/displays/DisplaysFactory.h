...
#include <QObject>
#include <QtPlugin>
#include "Displays_global.h"
#include "connector-core/IDataClassFactory.h"

namespace terbit
{

class DisplaysFactory : public QObject, public terbit::IDataClassFactory
{
   Q_OBJECT
   Q_PLUGIN_METADATA(IID IDataClassFactory_iid FILE "DisplaysFactory.json")
   Q_INTERFACES(terbit::IDataClassFactory)

public:
   DisplaysFactory();
   virtual ~DisplaysFactory();
