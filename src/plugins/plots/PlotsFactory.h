...
#include <QObject>
#include <QtPlugin>
#include "Plots_global.h"
#include "connector-core/IDataClassFactory.h"

namespace terbit
{

class PlotsFactory : public QObject, public terbit::IDataClassFactory
{
   Q_OBJECT
   Q_PLUGIN_METADATA(IID IDataClassFactory_iid FILE "PlotsFactory.json")
